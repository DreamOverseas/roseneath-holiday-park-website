...
// ⭐ Corrected import — this is the ONLY correct path
import PhoneFormatter from "./Pages/admin/PhoneFormatter.jsx";
    ...
    <I18nextProvider i18n={i18n}>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/smarthouse"
            element={<MediaImageDisplay chineseUrl="investment" />}
          />

          <Route
            path="/tiny-house"
            element={<MediaImageDisplay chineseUrl="tiny-house-chinese" />}
          />
          ...
          <Route
            path="/permanent-news"
            element={<News userType="forPermanent" />}
          />

          <Route path="/membership" element={<MemberCenter />} />

          {/* ⭐ Your admin tool route */}
          <Route path="/admin/phone-formatter" element={<PhoneFormatter />} />
